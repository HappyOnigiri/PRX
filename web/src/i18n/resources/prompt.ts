export const prompt = {
  en: {
    ...
    batchPrompt: {
      ...
      description:
        "One prompt covering the tasks you select. It names each task so the agent fetches its instructions from PRX. Edit the wording in Settings › Prompts.",
  ...
  ja: {
    ...
    batchPrompt: {
      ...
      title: "一括実装プロンプトをコピー",
      description:
        "選んだタスクをまとめた 1 つのプロンプトです。各タスクの指示はエージェントが PRX から取得します。文面は設定 › プロンプトで編集できます。",
