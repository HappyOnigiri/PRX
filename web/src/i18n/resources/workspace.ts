export const workspace = {
  en: {
    workspace: {
      ...
      flow: {
        nodeDescription:
          "Use the task ID copy button to copy its identifier, links to open references, or the Edit button to edit this task.",
  ...
  ja: {
    workspace: {
      ...
      flow: {
        nodeDescription:
          "タスクIDはコピー用ボタンから、参照資料はリンクから、タスクの変更は編集ボタンから行います。",
