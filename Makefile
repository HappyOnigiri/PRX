...
.PHONY: generate generated-check mod-tidy-check fmt lint check-web-quality test go-coverage-check go-coverage-update test-race test-cli web-install web-test web-build dev e2e build install ci clean $(GOLANGCI_LINT)
